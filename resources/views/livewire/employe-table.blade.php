                         ...
                         <tr class="bg-white border-b font-inter text-sm text-gray-500">
                              ...
                              <td class="py-4 px-6">
                                   ...
                                   <div class="flex gap-2 mx-auto">
                                        <a href="{{ route('admin.employe.show',$employe->user->id) }}"
                                        ...
                                        <form action="{{ route('admin.employe.destroy',$employe->user->id) }}" method="post">
                                             @csrf
                                             @method('delete')
                                             <button type="submit"
                                        ...
                                        <a href="{{ route('admin.employe.edit',$employe->user->id) }}" class="bg-amber-400 p-1 rounded-lg hover:bg-amber-500">
                                             <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                  fill="currentColor" class="w-5 h-5 text-white">
                                                  <path
