     ...
     <x-app-layout>
          ...
          <div class="flex gap-3">
               <a href="{{ route('print.detail-team', $team->id) }}"
                    class="py-2 px-4 bg-slate-500 text-white hover:bg-slate-400 rounded-lg my-6 flex gap-1">
                    <div class="">
               ...
               <a href="{{ route('myProject.sop', $team->id) }}"
                    class="py-2 px-4 bg-primary text-white hover:bg-cyan-400 rounded-lg my-6 flex gap-1">
                    <div class="">
               ...
               <a href="{{ route('chat-group.show', $team->id) }}"
                    class="py-2 px-4 bg-green-500 text-white hover:bg-green-400 rounded-lg my-6">
               ...
               <a href="{{ route('meeting.show', $team->id) }}"
                    class="py-2 px-4 bg-red-500 text-white hover:bg-red-400 rounded-lg my-6">
          ...
          <div class="mt-4 bg-white p-6 rounded-md max-w-7xl">
               <h1 class="my-4 text-2xl font-primary text-primary">Task Project</h1>
               <form action="" method="POST">
                    <input type="hidden" name="project_id" value="{{ $team->project->project_id }}">
                    @csrf
                    <div class="overflow-x-auto relative rounded-lg mr-3 bg-white dark:bg-slate-700 shadow">
                         <table class="w-full text-sm text-left text-gray-500 dark:bg-slate-700 ">
                              ...
                              <tbody class="allData">
                                   @foreach ($team->project->task as $value)
                                        <tr
                    ...
                    @if (auth()->user()->hasRole('admin') || auth()->user()->id == $team->project->user_id)
                         <button
