<x-admin>
<x-header title="Karyawan" description="Akses informasi Data Karyawan disini" icon="user-group-outline"/>
      <section>
         <div class="container max-w-7xl mx-auto md:p-6">
            <div class="flex w-full gap-3">
                    <a href="{{ route('admin.employe.create') }}"
                         class="py-2 flex text-white px-3 bg-primary hover:bg-cyan-400 shadow-sm text-center rounded-lg"
                    ...
                    <a class="py-2 w-42 gap-1 flex text-white px-3 bg-amber-400 hover:bg-amber-500 shadow-sm text-center rounded-lg"
                         href="{{ route('print.all-employe') }}" target="_BLANK">
                         <div class="">
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                   class="w-6 h-6">
                                   <path fill-rule="evenodd"
