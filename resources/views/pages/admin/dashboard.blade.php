                                             ...
                                             @foreach ($categories as $category)
                                                  <div class="col">
                                                       <x-category icon="{!! $category->icon->value !!}"
                                                            ...
                                                            href="{{ route('admin.category.show', $category->slug) }}" />
                                                  </div>
                                             @endforeach
                                        </div>
                                   </section>
                                        ...
                                        @foreach ($activities as $activity)
                                             ...
                                             <div
                                                  ...
                                                  <div class="md:flex gap-4 mb-3">
                                                       @if (!empty($activity->user->getFirstMediaUrl('profile')))
                                                  ...
                                                  <div class="col-auto text-gray-800 dark:text-gray-200 leading-6">
                                                       {{ $activity->value }}
                                                  </div>
                                                       ...
                                                       <div class="flex align-items-center w-full justify-between">
                                                            <div class="flex w-1/2">
                                                                 <div
                                                                      ...
                                                                      {{ $activity->link->folder->category->name }} /
                                                                      {{ $activity->link->folder->name }}
                                                                 </div>
                                                            </div>
