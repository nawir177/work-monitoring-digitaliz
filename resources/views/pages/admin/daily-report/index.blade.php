...
<x-admin>
     <div class="container p-2">
          ...
          <div class="flex">
               <form action="{{ route('admin.daily-report.store') }}" method="POST">
                    @csrf
                              ...
                              <tr class="bg-white border-b font-inter text-sm text-gray-500">
                                   ...
                                   <td class="py-4 px-6">
                                        ...
                                        <div class="flex gap-2 mx-auto">
                                             <a href="{{ route('admin.daily-report.show',$value->id) }}" class="py-2 px-3 rounded-lg bg-amber-400 hover:bg-amber-300 text-white">
                                                  Open
                                             </a>
                                        </div>
                                   </td>
